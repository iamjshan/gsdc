    ...
    async function getAllSurveys() {
        ...
        surveys.forEach(function(s) {
            if (s.stationId) {
                ...
                // 调试输出
                if (s.supplyTimesPerDay || s.supplyHoursPerTime || s.investigator) {
                    console.log('IndexedDB getAllSurveys:', s.stationId, 'investigator:', s.investigator, 'supplyTimesPerDay:', s.supplyTimesPerDay, 'supplyHoursPerTime:', s.supplyHoursPerTime);
                }
            } else {
